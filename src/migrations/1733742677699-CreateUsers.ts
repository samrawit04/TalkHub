...
export class CreateUsers1733742677699 implements MigrationInterface {
    name = 'CreateUsers1733742677699'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "questions" ADD "questiontitle" text NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "questions" DROP COLUMN "questiontitle"`);
